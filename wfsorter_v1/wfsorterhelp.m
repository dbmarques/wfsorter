...
%   
%   Inputs:
%       X = data(observations,variables). If is a vector (signal) performs
%           waveform detection based on threshold. If is array (waveforms) 
%           goes directly to sorting and uses "thr" and "L" inputs
%           differently
...
%           If X is array, "thr" is used as indices/timestamps.
...
%       Restart = Restart sorting with original data, with no units.
% 
